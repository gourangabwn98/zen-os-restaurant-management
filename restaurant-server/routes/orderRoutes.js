...
router.patch("/:id/confirm", protect, requireStaff, requireWaiterOnDuty, confirmOrder);
router.patch("/:id/approve", protect, requireStaff, requireWaiterOnDuty, approveOrder);
router.patch("/:id/reject",  protect, requireStaff, requireWaiterOnDuty, rejectOrder);
