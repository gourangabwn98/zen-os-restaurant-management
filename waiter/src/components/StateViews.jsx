import { BLUE, TEXT_MUTED, TEXT_FAINT } from "../theme.js";
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", alignItems: "center", padding: "60px 20px", gap: 12 }}>
      <div style={{
        ...
        border: "3px solid #dbeafe", borderTopColor: BLUE,
    ...
    <div style={{ textAlign: "center", padding: "60px 24px" }}>
      ...
      {onRetry && (
        <button onClick={onRetry} style={{
          marginTop: 16, padding: "9px 20px", borderRadius: 20, border: `1.5px solid ${BLUE}`,
          background: "#fff", color: BLUE, fontWeight: 700, fontSize: 13, cursor: "pointer",
        }}>
          Try again
        </button>
      )}
